...
import { WORKOUTS, SCHEMES } from '../utils/sweatpro'
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3  gap-4">
        {Object.keys(SCHEMES).map((schemes, schemesIndex) => {
          return (
            <button onClick={() => {
              setGoal(schemes)
            }} className={'bg-slate-950 border px-4 duration-200 hover:border-blue-600  py-3 rounded-lg' + (schemes === goal ? ' border-blue-600' : ' border-blue-400 ')} key={schemesIndex}>
